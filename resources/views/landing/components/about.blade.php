        ...
        <div class="flex flex-col items-start font-sans md:flex-row">
            <div class="flex-1 md:pr-8">
                ...
                <p class="max-w-lg mx-auto mt-3 text-xl leading-relaxed text-center md:mx-0 md:text-left">
                    ...
                    <span class="font-bold">affordable</span> digital and business
                ...
                <button
                    class="rounded-lg border-0 bg-[#ff3033] w-full md:w-auto px-6 py-4 mt-[20px] text-lg text-white shadow-lg shadow-slate-300 transition hover:bg-[#b99c9c] hover:text-slate-900 dark:shadow-sm sm:py-3"
                    onclick="window.location.href='{{ route('register') }}'">
                    Get Started Now
                </button>
            </div>
            <div class="flex-1 text-center md:text-right">
                <img class="relative w-full xl:mx-auto lg:h-[550px] xl:h-auto mt-8 md:mt-0 rounded"
                    src="./src/assets/advisorabout.jpg" alt="" />
            </div>
        </div>
    </div>
</section>
