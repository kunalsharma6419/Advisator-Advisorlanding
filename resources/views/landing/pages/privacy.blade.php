...
@section('landingcontent')
    <div class="relative overflow-x-hidden w-full bg-gray-50">
        <!-- Header -->
        @include('landing.components.header')

        <!-- main -->
        <div
            class="flex flex-col font-sans text-gray-800 w-[90%] md:w-[95%] lg:w-[80%] mx-auto my-8 p-6 lg:p-12 bg-white shadow-lg rounded-lg">
            <h1 class="text-3xl font-bold mb-6">Privacy Policy</h1>
            <p class="text-sm text-gray-500 mb-2">Last updated: June 23, 2024</p>
            <p class="mb-4">This Privacy Policy describes Our policies and procedures on the collection, use, and
                ...
                law protects You.</p>
            <p class="mb-6">We use Your Personal data to provide and improve the Service. By using the Service, You agree
                to the collection and use of information in accordance with this Privacy Policy. This Privacy Policy has
                been created with the help of the <a href="https://www.termsfeed.com/privacy-policy-generator/"
                    target="_blank" class="text-blue-600 hover:underline">Privacy Policy Generator</a>.</p>

            <h2 class="text-2xl font-semibold mt-8 mb-4">Interpretation and Definitions</h2>

            <h3 class="text-xl font-medium mt-6 mb-2">Interpretation</h3>
            ...
            <h3 class="text-xl font-medium mt-6 mb-2">Definitions</h3>
            ...
            <ul class="list-disc list-inside mb-6 space-y-2">
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                        &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SHIFT 180 BUSINESS ADVISORY AND
                        SERVICES PRIVATE LIMITED, Flat No 1901 S.no 285/1.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to Advisator, accessible from <a href="https://advisator.com"
                            rel="external nofollow noopener" target="_blank"
                            class="text-blue-600 hover:underline">https://advisator.com</a></p>
                </li>
                <li>
            ...
            <h2 class="text-2xl font-semibold mt-8 mb-4">Collecting and Using Your Personal Data</h2>

            <h3 class="text-xl font-medium mt-6 mb-2">Types of Data Collected</h3>

            <h4 class="text-lg font-medium mt-4 mb-2">Personal Data</h4>
            ...
            <h4 class="text-lg font-medium mt-4 mb-2">Usage Data</h4>
            ...
            <p class="mb-6">We may also collect information that Your browser sends whenever You visit our Service or when
                You access the Service by or through a mobile device.</p>

            <h4 class="text-lg font-medium mt-4 mb-2">Tracking Technologies and Cookies</h4>
            <p class="mb-4">We use Cookies and similar tracking technologies to track the activity on Our Service and
            ...
            <p class="mb-4">Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies
                ...
                soon as You close Your web browser. You can learn more about cookies on <a
                    ...
                    class="text-blue-600 hover:underline">TermsFeed website</a> article.</p>
            ...
            <h2 class="text-2xl font-semibold mt-8 mb-4">Use of Your Personal Data</h2>
            ...
            <ul>
                <li>
                    <p>By email: advisory@shift180.in</p>
                </li>
                <li>
                    <p>By visiting this page on our website: <a href="advisator.com" rel="external nofollow noopener"
                            target="_blank">advisator.com</a></p>
                </li>
            </ul>
            <br>
