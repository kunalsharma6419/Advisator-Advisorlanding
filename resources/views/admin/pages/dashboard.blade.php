            ...
            <div class="main-panel">
                <div class="content-wrapper pb-0">
                    <div class="page-header flex-wrap">
                        <h3 class="mb-0">Hi, welcome back! <span class="ps-0 h6 ps-sm-2 text-muted d-inline-block">Your
                            ...
                            <div class="card">
                                <div class="card-body px-0 overflow-auto">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../../admin/assets/images/faces/face10.jpg"
                                                                alt="image" />
                                                            <div class="table-user-name ms-3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../../admin/assets/images/faces/face11.jpg"
                                                                alt="image" />
                                                            <div class="table-user-name ms-3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../../admin/assets/images/faces/face13.jpg"
                                                                alt="image" />
                                                            <div class="table-user-name ms-3">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            <img src="../../../admin/assets/images/faces/face16.jpg"
                                                                alt="image" />
                                                            <div class="table-user-name ms-3">
                                    ...
                                    <a class="text-black mt-3 d-block ps-4" href="#"> <span
                                            class="font-weight-medium h6">View all order history</span> <i
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap border-bottom py-2 border-top justify-content-between">
                                        <img class="survey-img mb-lg-3" src="../../../admin/assets/images/dashboard/img_3.jpg"
                                            alt="">
                                        <div class="pt-2">
                                    ...
                                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                                        <img class="survey-img mb-lg-3" src="../../../admin/assets/images/dashboard/img_1.jpg"
                                            alt="">
                                        <div class="pt-2">
                                    ...
                                    <div class="d-flex flex-wrap border-bottom py-2 justify-content-between">
                                        <img class="survey-img mb-lg-3" src="../../../admin/assets/images/dashboard/img_2.jpg"
                                            alt="">
                                        <div class="pt-2">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="add-items d-flex flex-wrap flex-sm-nowrap">
                                        ...
                                        <button class="add btn btn-primary font-weight-regular  text-nowrap"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-12 col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-md-4">
                                                    <img class="customer-img" src="../../../admin/assets/images/faces/face22.jpg"
                                                        alt="">
                                                </div>
                                        ...
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="../../../admin/assets/images/faces/face25.jpg"
                                                        alt="">
                                                </div>
                                    ...
                                    <div class="row py-1">
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="../../../admin/assets/images/faces/face15.jpg"
                                                        alt="">
                                                </div>
                                                <div class="col-8 col-sm-8 p-sm-0">
                                    ...
                                    <div class="row py-1">
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="../../../admin/assets/images/faces/face5.jpg"
                                                        alt="">
                                                </div>
                                                <div class="col-8 col-sm-8 p-sm-0">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-7">
                                            <div class="row">
                                                <div class="col-4 col-sm-4">
                                                    <img class="customer-img" src="../../../admin/assets/images/faces/face2.jpg"
                                                        alt="">
                                                </div>
                                                <div class="col-8 col-sm-8 p-sm-0">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row border-bottom pb-3 pt-4 align-items-center mx-0">
                                        <div class="col-sm-9 ps-0">
                                            <div class="d-flex">
                                                <img src="../../../admin/assets/images/dashboard/img_4.jpg" alt="">
                                                <div class="ps-2">
                                    ...
                                    <div class="row mt-5">
                                        <div class="col-sm-12">
                                            <ul class="d-flex ps-0 overflow-auto">
                                                <li
                                                    class="weakly-weather-item text-white font-weight-medium text-center active">
                                            ...
                                            <p class="text-muted">
                                                ...
                                                <span class=" d-inline-block">
                                                    <span class="d-flex d-inline-block">
                                                        <img class="ms-1" src="../../../admin/assets/images/faces/face1.jpg"
                                                            alt="">
                                                        <img class="ms-1" src="../../../admin/assets/images/faces/face10.jpg"
                                                            alt="">
                                                        <img class="ms-1" src="../../../admin/assets/images/faces/face14.jpg"
                                                            alt="">
                                                    </span>
                                                </span>
                                            </p>
                                            ...
                                            <div class="col-5 col-sm-4">
                                                <div class="d-flex pt-1 align-items-center">
                                                    ...
                                                    <div class="dropdown dropleft ps-1 pt-3">
                                                        <div id="dropdownMenuButton2" data-bs-toggle="dropdown"
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-5 col-sm-4">
                                                <div class="d-flex pt-1 align-items-center">
                                                    ...
                                                    <div class="dropdown dropleft ps-1 pt-3">
                                                        <div id="dropdownMenuButton3" data-bs-toggle="dropdown"
                                                            role="button" aria-haspopup="true" aria-expanded="false">
                                                            <p><i class="mdi mdi-dots-vertical"></i></p>
                                                        </div>
                                    ...
                                    <div class="list-card">
                                        <div class="row align-items-center">
                                            <div class="col-7 col-sm-8">
                                                <div class="row align-items-center">
                                                    <div class="col-sm-4">
                                                        <img src="../../../admin/assets/images/faces/face11.jpg" alt="">
                                                    </div>
                                                    <div class="col-sm-8 pe-0 pl-sm-0">
                                            ...
                                            <div class="col-5 col-sm-4">
                                                <div class="d-flex pt-1 align-items-center">
                                                    ...
                                                    <div class="dropdown dropleft ps-1 pt-3">
                                                        <div id="dropdownMenuButton4" data-bs-toggle="dropdown"
                                                            role="button" aria-haspopup="true" aria-expanded="false">
                                                            <p><i class="mdi mdi-dots-vertical"></i></p>
                                                        </div>
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-5 col-sm-4">
                                                <div class="d-flex pt-1 align-items-center">
                                                    ...
                                                    <div class="dropdown dropleft ps-1 pt-3">
                                                        <div id="dropdownMenuButton5" data-bs-toggle="dropdown"
                                                            role="button" aria-haspopup="true" aria-expanded="false">
                                                            <p><i class="mdi mdi-dots-vertical"></i></p>
                                                        </div>
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                                <div>
                                                    <img class="me-2"
                                                        src="../../../admin/assets/images/browser-logo/opera-logo.png"
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between pb-3 border-bottom">
                                                <div>
                                                    <img class="me-2"
                                                        src="../../../admin/assets/images/browser-logo/chrome-logo.png"
                                    ...
                                    <div class="row py-2">
                                        <div class="col-sm-12">
                                            <div class="d-flex justify-content-between">
                                                <div>
                                                    <img class="me-2"
                                                        src="../../../admin/assets/images/browser-logo/explorer-logo.png"
