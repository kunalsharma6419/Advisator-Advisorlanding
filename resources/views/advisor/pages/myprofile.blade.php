...
@section('advisorcontent')
    <div class="w-full min-h-screen h-full relative overflow-hidden">
                    ...
                    <div class="grow border shadow-sm p-4 rounded-xl flex gap-6">
                        ...
                        <div class="grow">
                            <form action="">
                                ...
                                <div class="w-full mb-6">
                                    <label class="text-[#828282] font-normal text-base" for="fullname">Number</label>
                                    <div
                                ...
                                <div class="w-full mb-6">
                                    <label class="text-[#828282] font-normal text-base" for="locaiton">Location</label>
                                    <input type="text" placeholder="Enter Location" id="location"
                                        class="text-[#3A3A3A] placeholder:text-[#3A3A3A] text-base font-medium outline-none rounded-lg mt-[6px] bg-[#FFFFFF] border border-[#E1E9D3] shadow-md w-[95%] lg:w-[90%]  p-2 ">
                                </div>
                                <div class="w-full mb-6">
                                    <label class="text-[#828282] font-normal text-base" for="businessFunction">Business
                                        functions</label>
                                ...
                                <div class="w-full mb-6">
                                    ...
                                    <textarea
                                        ...
                                        name="" id="">Enter Description</textarea>
                                </div>
                ...
                <div class="hidden md:flex mt-8">
                    ...
                    <div class="grow border  shadow-sm p-5 rounded-xl ">
                        <div class="flex items-center justify-between gap-2  w-full">
                            <p class="font-medium text-base text-[#2A2A2A]">Set Your Advisory Price (per minute)</p>
                            <div class="border-2 borderr-[#828282] px-6 py-2 bg-[#FFFFFF] rounded-lg">
                                <button class="bg-[#DB5001] text-[#FFFFFF] rounded-lg px-3 py-1">Minute</button>
                                <button class="bg-transparent text-[#2A2A2A] rounded-lg px-3 py-1">Hour</button>
                            </div>
                        </div>
                            ...
                            <div class="flex flex-col gap-2">
                                ...
                                <div class="flex gap-2 lg:gap-4 items-end">
                                    <div class="flex flex-col gap-2 text-base">
                                        ...
                                        <p
                                            class="text-base text-[#3A3A3A] font-semibold py-1 lg:py-2 px-1 lg:px-3 bg-[#FFFFFF] border border-[#E1E9D3] rounded-lg shadow-md">
                                            INR (₹)</p>
                                    </div>
                                    <div class="w-[1.5rem] mb-4 border border-[#000000e2]"></div>
                                    <div class="flex flex-col gap-2 text-base">
        ...
        <!-- calender for medium and large screen -->
        <div id="calenderLg" style="display: none;" class="hidden lg:block p-1 lg:p-8">
        ...
        <!-- calender for small screen -->
        <div id="calendersm" style="display: none;" class="bg-white p-2 block lg:hidden">
            <h2 class="text-[20px] font-[500] text-[#526E1C]">
                Choose your Availability
            </h2>
            <table class="w-full mt-[30px]">
