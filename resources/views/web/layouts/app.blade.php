...
<body class="fixed-bottom-bar">
                                ...
                                CometChat.startCall(
                                    ...
                                    new CometChat.OngoingCallListener({
                                        ...
                                        onCallEnded: call => {
                                            ...
                                            const advisorId =
                                                receiverId; // Update with the correct property if different


                                            document.getElementById('call-screen').style
                                                .display =
                                                'none'; // Hide call screen after the call ends
                                            document.getElementById('calling-ui').style
                                                .display = 'none'; // Hide calling UI
    ...
    <script>
        ...
        setInterval(() => {
            ...
            if (widthThreshold || heightThreshold) {
                ...
                window.location.href = "error.html"; // Example redirection
            } else {
                devtoolsOpen = false;
            }
        }, 500);
    ...
    <script>
        ...
        const threshold = 160;
        setInterval(() => {
            if (window.outerWidth - window.innerWidth > threshold || window.outerHeight - window.innerHeight >
                threshold) {
                if (!devtoolsOpen) {
                    devtoolsOpen = true;
