        ...
        <body class="font-inter">      
            <section class="relative pt-20 pb-24 bg-[#6A9023]">
              <div class="w-full max-w-lg md:max-w-2xl lg:max-w-4xl px-5 lg:px-11 mx-auto max-md:px-4">
                <h1 class="text-white font-manrope font-semibold text-4xl min-[500px]:text-5xl leading-tight mb-8">Maha Shivratri and International Women's Day on the same day</h1>
                <div class="flex items-center justify-between">
                  <div class="data">
                    <p class="font-medium text-xl leading-8 text-white mb-1">24 March 2024</p>
                    <p class="font-normal text-lg leading-7 text-white">Organisational Excellence</p>
                  </div>
            ...
            <section class="relative py-10 lg:py-16 ">
              <div class="w-full max-w-lg md:max-w-2xl lg:max-w-4xl px-5 lg:px-11 mx-auto max-md:px-3">
                ...
                <div class="img w-auto mb-14">
                    <img src="{{ asset('blogs/MahaShivratriday.webp') }}" alt="Blog tailwind page" class="object-cover">
                  </div>


                  <div class="head-4 mb-14">
                    <p class="font-normal text-lg leading-8 text-gray-600">
                        Maha Shivratri and International Women's Day on the same day carries profound meaning. Maha Shivratri signifies the union of Shiva with Shakti, symbolizing the balance and harmony between masculine and feminine energies, the fundamental forces of the universe.

                        In the competitive landscape, organizations sometimes set aggressive growth targets driven solely by top management's whims. Amidst this pursuit, there's a risk of losing sight of the organization's original purpose and overlooking well being of employees potentially resulting in conflicts and exclusions.
                        
                        Here, the feminine energy, embodied as MahaLakshmi-Shakti, aligns growth objectives with the imperative of nurturing inclusivity and purpose-driven development.
                        
                        Creating organizations that empower feminine energy involves cultivating a unique skill set conducive to creativity and inclusivity. Women, often associated with emotional intelligence, bring inherent abilities that enhance workplace inclusivity and humanity.
                        
                        In an era where machines are increasingly replacing human labor, it's essential not to overlook the importance of nurturing and supporting our fellow beings. While the development of machines aims to enhance efficiency and productivity, it should not overshadow the value of human connection and care. After all, the purpose of building machines is ultimately to support and complement the capabilities of humans
                        
                        With these thoughts Shift180 wishes you Happy Maha Shivratri and Happy Womens Day 
                    </p>
