...
<a href="https://wa.me/+919810440780" target="_blank" class="fixed bottom-16 right-4 md:hidden z-50"
    style="margin-bottom: 20px;">
    <svg class="w-16 h-16 text-green-500 bg-white rounded-full p-2 shadow-lg" viewBox="0 0 24 24" fill="currentColor"
