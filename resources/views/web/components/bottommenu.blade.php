<div class="bg-[#FFFFFF] left-0 z-20 shadow-2xl h-[80px] fixed md:hidden bottom-0 w-full">
    ...
    <div
        ...
        <a href="{{ route('consult-advisor') }}" class="flex flex-col items-center justify-center gap-1">
            <img class="cursor-pointer w-7 h-7 sm:h-8 sm:w-8" src="{{ Request::is('consult-advisor') ? asset('src/assets/bottomNavbar/activeAdvisor.png') : asset('src/assets/bottomNavbar/advisor.png') }}"
                    alt="Consult Advisor" />
